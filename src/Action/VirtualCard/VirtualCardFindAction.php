...
namespace App\Action\VirtualCard;
 ...
 * Action.
 */
final class VirtualCardFindAction
{
    protected VirtualCardFinderService $service;

    protected JsonRenderer $renderer;

    /**
     * @param VirtualCardFinderService $service
     * @param JsonRenderer $jsonRenderer
     */
    public function __construct(VirtualCardFinderService $service, JsonRenderer $jsonRenderer)
    {
